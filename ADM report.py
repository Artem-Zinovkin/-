...
book1 = openpyxl.open(r'E:\Работа Дез-Эльтор\БЕЛГОРОД\АДМ\ОТЧЕТЫ\Чек лист 2022\08\Чек-лист АДМ 05.08.2022.xlsx',
                      read_only=True)
sheet1 = book1.worksheets[0]
book2 = openpyxl.open(r'E:\Работа Дез-Эльтор\БЕЛГОРОД\АДМ\ОТЧЕТЫ\Чек лист 2022\08\Чек-лист АДМ 12.08.2022.xlsx',
                      read_only=True)
sheet2 = book2.worksheets[0]
book3 = openpyxl.open(r'E:\Работа Дез-Эльтор\БЕЛГОРОД\АДМ\ОТЧЕТЫ\Чек лист 2022\08\Чек-лист АДМ 19.08.2022.xlsx',
                      read_only=True)
sheet3 = book3.worksheets[0]
book4 = openpyxl.open(r'E:\Работа Дез-Эльтор\БЕЛГОРОД\АДМ\ОТЧЕТЫ\Чек лист 2022\08\Чек-лист АДМ 26.08.2022.xlsx',
                      read_only=True)
...
for row in range(sheet1.min_row, sheet1.max_row):
    ...
    if znachenie2.isdigit() or znachenie4.isdigit() or znachenie6.isdigit() or znachenie8.isdigit():
        ...
        summ_mes = ((int(znachenie2) + int(znachenie4) + int(znachenie6) + int(
            znachenie8)) / 4)  # средняя поедаемость в контейнере за месяц
        vsego_mes1 += summ_mes
